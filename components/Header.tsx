...
const Sidebar: React.FC<SidebarProps> = ({ currentView, setCurrentView, onAddBook }) => {
  const navItems = [
    { view: View.DASHBOARD, label: 'لوحة الإحصائيات', icon: 'dashboard' as const },
    { view: View.INCOMING, label: 'الكتب الواردة', icon: 'inbox' as const },
    { view: View.OUTGOING, label: 'الكتب الصادرة', icon: 'outbox' as const },
  ];
